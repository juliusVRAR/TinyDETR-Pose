...
parser.add_argument("--datapath", default="/workspace/data/bop", type=str, help="path to ycbv dataset")
parser.add_argument("--keyframes", default="./data/ycbv/keyframe.txt", type=str, help="path to the keyframes file list")
parser.add_argument("--split", default='test', type=str, help="split can be either train or test")
