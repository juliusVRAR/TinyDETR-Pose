...
python -u -m torch.distributed.launch \
                ...
                /workspace/LWDETR/main.py \
                            ...
                            --rgb_augmentation \
                            --tensorboard \
                            --pretrained_encoder /workspace/LWDETR/data/weights/caev2_M_L_300e_objects365.pth\
                            --pretrain_weights /workspace/LWDETR/data/weights/LWDETR_medium_30e_objects365.pth \
                            --matcher_type "6d"
