...
def build(args):
    ...
    import models.lwdetr
    backbone = models.lwdetr.build(args) # Doing the 2D detections
    #TODO: Does this make sense?
    transformer = build_transformer(args) # Same transformer as LWDETR is using.
    model = PoET(
        backbone,
        transformer,
